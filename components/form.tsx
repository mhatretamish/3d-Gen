...
export default function Form({ isLoading, onSubmit, onOpenOptions }: FormProps) {
  ...
  return (
    <UIForm {...form}>
      <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)} className="relative pb-2">
        <div
          ref={dropAreaRef}
          className={cn(
            "relative bg-black/60 backdrop-blur-md rounded-[24px] overflow-hidden transition-all shadow-lg border",
            isDragging
        ...
        >
            ...
            <div className="flex items-center">
              <div className="flex space-x-0">
                ...
                <Button
                  ...
                  className="text-gray-400 hover:text-cyan-400 hover:bg-transparent rounded-full h-10 w-10 ml-0"
                  disabled={isLoading}
                >
              ...
              <div>
                <Button
                  type="submit"
                  className="bg-gradient-to-r from-cyan-600 to-cyan-500 hover:from-cyan-500 hover:to-cyan-400 text-white rounded-full h-10 w-10 p-0 flex items-center justify-center"
                  disabled={isLoading}
                >
          ...
          {isDragging && (
            <div className="absolute inset-0 bg-black/80 flex items-center justify-center pointer-events-none z-10">
              <p className="text-cyan-400 font-medium tracking-normal text-lg">Drop images here</p>
            </div>
          )}
        </div>
